...
public class RedisExecProvider {
    ...
    private void initExecutables() {
        executables.put(OsArchitecture.WINDOWS_x86, "redis-server-2.8.24.exe");
        executables.put(OsArchitecture.WINDOWS_x86_64, "redis-server-2.8.24.exe");

        executables.put(OsArchitecture.UNIX_x86, "redis-server-2.8.24-32");
        executables.put(OsArchitecture.UNIX_x86_64, "redis-server-2.8.24");

        executables.put(OsArchitecture.MAC_OS_X_x86, "redis-server-2.8.24.app");
        executables.put(OsArchitecture.MAC_OS_X_x86_64, "redis-server-2.8.24.app");
    }
