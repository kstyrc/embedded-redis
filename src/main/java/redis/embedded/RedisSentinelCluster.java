...
public class RedisSentinelCluster implements Redis {
    private final List<Redis> sentinels = new LinkedList<Redis>();
    private final List<Redis> servers = new LinkedList<Redis>();

    RedisSentinelCluster(List<Redis> sentinels, List<Redis> servers) {
    ...
    public static RedisSentinelClusterBuilder builder() {
        return new RedisSentinelClusterBuilder();
    }
}
