...
public class RedisSentinelClusterTest {
    ...
    private RedisSentinelCluster instance;
    ...
    public void stopShouldStopEntireCluster() throws Exception {
        ...
        instance = new RedisSentinelCluster(sentinels, servers);
    ...
    public void testSimpleOperationsAfterRunWithSingleMasterNoSlavesCluster() throws Exception {
        //given
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().sentinelCount(1).replicationGroup("ourmaster", 0).build();
        cluster.start();
    ...
    public void testSimpleOperationsAfterRunWithSingleMasterAndOneSlave() throws Exception {
        //given
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().sentinelCount(1).replicationGroup("ourmaster", 1).build();
        cluster.start();
    ...
    public void testSimpleOperationsAfterRunWithSingleMasterMultipleSlaves() throws Exception {
        //given
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().sentinelCount(1).replicationGroup("ourmaster", 2).build();
        cluster.start();
    ...
    public void testSimpleOperationsAfterRunWithTwoSentinelsSingleMasterMultipleSlaves() throws Exception {
        //given
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().sentinelCount(2).replicationGroup("ourmaster", 2).build();
        cluster.start();
    ...
    public void testSimpleOperationsAfterRunWithTwoPredefinedSentinelsSingleMasterMultipleSlaves() throws Exception {
        ...
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().sentinelPorts(sentinelPorts).replicationGroup("ourmaster", 2).build();
        cluster.start();
    ...
    public void testSimpleOperationsAfterRunWithThreeSentinelsThreeMastersOneSlavePerMasterCluster() throws Exception {
        ...
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().sentinelCount(3).quorumSize(2)
    ...
    public void testSimpleOperationsAfterRunWithThreeSentinelsThreeMastersOneSlavePerMasterEphemeralCluster() throws Exception {
        ...
        final String master2 = "master2";
        final String master3 = "master3";
        final RedisSentinelCluster cluster = RedisSentinelCluster.builder().ephemeral().sentinelCount(3).quorumSize(2)
//        final RedisSentinelCluster cluster = RedisSentinelCluster.builder()
                .replicationGroup(master1, 1)
                .replicationGroup(master2, 1)
                .replicationGroup(master3, 1)
                .build();
